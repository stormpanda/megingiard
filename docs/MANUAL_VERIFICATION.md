...
| **3. Mirror Control Card** | • Locate the Mirror Control Card at the top of the Pill Menu.<br>• Displays mirroring status and control buttons: Play/Stop, Freeze/Unfreeze, and Screen Mirroring (Edit).<br>• Tap **Freeze** -> mirror freezes.<br>• Tap **Stop** -> mirroring ceases. | Mirror control buttons in the Pill Menu must remain in perfect sync with the capture service state. |
