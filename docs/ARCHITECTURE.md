...
| Privileged mirror direct physical-display transport      | Privileged mirror should avoid MediaCodec compression by remapping the secondary physical display to the primary layer stack; H.264 LocalSocket transport remains the compatibility fallback | [mirror/FEATURE.md](features/mirror/FEATURE.md#architecture-privileged-capture-pipeline-fr-m9) |
