...
| Privileged mirror direct-Surface transport               | Privileged mirror should avoid MediaCodec compression when Surface/layer handoff is available; H.264 LocalSocket transport remains the compatibility fallback                           | [mirror/FEATURE.md](features/mirror/FEATURE.md#architecture-privileged-capture-pipeline-fr-m9) |
