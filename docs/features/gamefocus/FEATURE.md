...
- Each RetroArch-compatible system definition MUST configure both a primary core (`retroArchCore`) and an alternative core (`retroArchCoreAlternative`) to prepare for future user-configurable core adjustments.
