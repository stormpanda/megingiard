...
| `TransitionOverlayManager.kt` | Captures the MainActivity window snapshot, instantiates the direct WindowManager overlay using a matching WindowContext, and coordinates attach/pre-draw events during Home interception first press. |
