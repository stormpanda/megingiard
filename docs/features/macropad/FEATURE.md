...
| `BackgroundSettingsEditor.kt`    | In-deck sub-page (`LayoutBackgroundSubPageContent`) for configuring background image, SteamGridDB scraping, dimming, crop preview, and mask effects.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
