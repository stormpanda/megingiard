...
- **Visual Action Pickers (`VisualKeyboardPicker`, `VisualGamepadPicker`, `VisualMousePicker`)**:
  - In the button editor, selecting the primary action card opens a dedicated visual sub-page picker:
    ...
    - **Visual Gamepad Picker**: Displays an interactive virtual controller layout matching the physical AYN Thor handheld (L1/L2, R1/R2 shoulders/triggers, Select & Start system buttons, Left Stick with L3 click and cardinal direction inputs, D-Pad cross, Home button, ABXY face buttons diamond respecting global face-button swap, and Right Stick with R3 click and cardinal direction inputs) with 2D D-pad spatial navigation.
    - **Visual Mouse Picker**: Displays a 2-column card grid of mouse clicks (Left, Right, Middle, Mouse 4, Mouse 5) and navigation actions.
  - Modifiers (Mod 1, Mod 2 for keyboard) and combo buttons (Extra 1, Extra 2, Extra 3 for gamepad) remain configurable directly on the `EditButton` page below the primary action card.
...
| `MacroPadEditor.kt`              | Full-screen layout editor built on `GamepadTwoPaneScaffold`: orchestrates the 5 sidebar categories (Profiles, Layouts, Canvas, Buttons, Macros), deck content columns, and in-deck sub-page stack navigation.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
