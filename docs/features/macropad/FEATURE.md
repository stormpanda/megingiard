...
- **Background Settings Overlay** (`BackgroundSettingsOverlay`): Configures the active layout\'s dimming parameters, edge blending, and per-cutout touch tracking and smoothing settings.
...
| `BackgroundSettingsOverlay.kt`   | Per-layout background settings editor: dimming, edge blending, and per-cutout touch tracking and smoothing                                                                                                                                                                                                                                                                                                                                                          |
