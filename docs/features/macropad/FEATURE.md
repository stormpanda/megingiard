...
- A new layout can be created as a **blank** layout. When creating a new layout, the Layout Settings edit dialog (`InlineLayoutSettingsOverlay`) is displayed immediately to configure the name, visibility, background image, and button colors.
