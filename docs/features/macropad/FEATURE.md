...
| `MacroPadEditor.kt`              | Full-screen layout editor built on `GamepadTwoPaneScaffold`: orchestrates the 5 sidebar categories (Profiles, Layouts, Background, Buttons, Macros), deck content columns, and in-deck sub-page stack navigation. |
