...
| `RecordingMirrorPresentation.kt` | `android.app.Presentation` shown on the secondary display during touch recording; creates its own `VirtualDisplay` from the shared `MediaProjection` token (or routes directly to the privileged daemon in privileged mode); captures the first tap via `pointerInput` and calls `TouchRecordingManager.onTapRecorded`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
