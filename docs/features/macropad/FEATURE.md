...
- **Visual Action Pickers (`VisualKeyboardPicker`, `VisualGamepadPicker`, `VisualMousePicker`)**:
  - In the button editor, selecting the primary action card opens a dedicated visual sub-page picker:
    ...
    - **Visual Gamepad Picker**: Displays an interactive virtual controller layout (L1/L2, R1/R2 shoulder/trigger clusters, system buttons, L3/R3 stick clicks, face buttons diamond respecting global face-button swap) with 2D D-pad navigation.
