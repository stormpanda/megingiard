...
| `MacroPadEditor.kt`              | Full-screen layout editor: profile/layout CRUD, drag-repositioning, button config; layout bar with `AppSelectableChip` layout selectors, drag-reorder, and enable/disable toggles; template selection for new layouts; toolbar above the canvas with chips for "Add Button", "Macros…", and grid toggle                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
