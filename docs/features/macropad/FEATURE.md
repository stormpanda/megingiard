...
| `PadCanvas.kt`                   | Bottom-screen live editor pad canvas: button drag positioning, grid overlay rendering (`GridMode`, `GridOverlay`), snap functions (`snapRectangular`, `snapRadial`); accepts `layout: PadLayout?`, `gridMode`, and `isLocked` parameters                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
