...
- **Interactive Anchor Testing Mode (`AnchorTestCoordinator`, `AnchorTestingSheet`):**
  ...
  - Display 4 hosts `AnchorTestingSheet` featuring:
    - **Dual Preview Area:** Displays the calibrated target reference signature (`AnchorPreviewCard`) alongside the live screen crop in real-time.
