...
App (UID 10xxx)                          megingiard_privd (UID 2000, u:r:shell:s0)
  ...
  │                                          │ setDisplayLayerStack(primary) + rotated/aspect-fit projection
