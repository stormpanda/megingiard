...
### Phase 0: Datenmodell *(blockiert alle anderen Phasen)*
...
### Phase 1: Idle Pill & Navigation *(abhängig von Phase 0)*
...
### Phase 7: Settings & Export/Import *(abhängig von Phase 0 + 6)*
...
### Phase 8: Aufräumen *(nach allen Phasen)*
